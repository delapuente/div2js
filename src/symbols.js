...
define([], function () {
  ...
  return {
    ...
    // TODO: Make wellKnownGlobals and wellKnownLocals external, to be
    // configurable in a separated way.

    // XXX: The definition format of the memory map is described here.
    //
